...
const routes = [
  ...
  { path: '/', component: () => import('../views/layout/MainLayout.vue'), redirect: '/dashboard', meta: { requiresAuth: true },
    children: [
      ...
      { path: 'dorm/buildings', name: 'Buildings', meta: { role: [0, 2] }, component: () => import('../views/dorm/BuildingView.vue') },
      { path: 'dorm/rooms', name: 'Rooms', meta: { role: [0, 2] }, component: () => import('../views/dorm/RoomView.vue') },

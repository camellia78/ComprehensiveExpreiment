...
-- 初始数据 (密码 123456 的 BCrypt 值)
INSERT INTO sys_user(id, username, password, real_name, role, student_no, phone, gender, is_deleted)
VALUES (1, ''admin'', ''$2a$10$N.zmdr9k7uOCQbNoA8X3Ou.gXCwIBwGfXWYm5fQxjQkUwqDpL5gL2'', ''系统管理员'', 0, NULL, ''13800000000'', 0, 0);
INSERT INTO sys_user(id, username, password, real_name, role, student_no, phone, gender, is_deleted)
VALUES (2, ''zhangsan'', ''$2a$10$N.zmdr9k7uOCQbNoA8X3Ou.gXCwIBwGfXWYm5fQxjQkUwqDpL5gL2'', ''张三'', 1, ''2024001'', ''13800000001'', 1, 0);
INSERT INTO sys_user(id, username, password, real_name, role, student_no, phone, gender, is_deleted)
VALUES (3, ''lisi'', ''$2a$10$N.zmdr9k7uOCQbNoA8X3Ou.gXCwIBwGfXWYm5fQxjQkUwqDpL5gL2'', ''李四'', 1, ''2024002'', ''13800000002'', 0, 0);

INSERT INTO dorm_building(id, name, building_no, floors, building_type, is_deleted)
VALUES (1, ''1号宿舍楼'', ''A01'', 6, 0, 0);
INSERT INTO dorm_building(id, name, building_no, floors, building_type, is_deleted)
VALUES (2, ''2号宿舍楼'', ''A02'', 6, 1, 0);
